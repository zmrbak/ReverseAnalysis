...
; Line 17
	...
	call	printf
; Line 18
	lea	r9, OFFSET FLAT:?multi_result@@3HA	; multi_result
	lea	r8, OFFSET FLAT:?sum_result@@3HA	; sum_result
	mov	edx, 456				; 000001c8H
	mov	ecx, 123				; 0000007bH
	call	?f@@YAXHHPEAH0@Z			; f
; Line 19
	mov	r8d, DWORD PTR ?multi_result@@3HA	; multi_result
	mov	edx, DWORD PTR ?sum_result@@3HA		; sum_result
