...
; Line 28
	...
	call	printf
; Line 29
	movsd	xmm1, QWORD PTR __real@405edd2f20000000
...
; Line 32
	...
	call	printf
; Line 33
	movsd	xmm1, QWORD PTR __real@c05edd2f20000000
...
; Line 20
	xor	DWORD PTR i$[rsp], -2147483648		; 80000000H
; Line 21
...
; Line 13
	movss	DWORD PTR [rsp+8], xmm0
; Line 14
	or	DWORD PTR i$[rsp], -2147483648		; 80000000H
; Line 15
	movss	xmm0, DWORD PTR temp$[rsp]
; Line 16
	ret	0
...
; Line 7
	movss	DWORD PTR [rsp+8], xmm0
; Line 8
	and	DWORD PTR i$[rsp], 2147483647		; 7fffffffH
; Line 9
	movss	xmm0, DWORD PTR temp$[rsp]
; Line 10
	ret	0
